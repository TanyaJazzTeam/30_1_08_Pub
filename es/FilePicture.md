...
- Importe un archivo HTML y observe cómo se convierte mágicamente a Markdown (мод1)
- Arrastra y suelta imágenes (requiere que tu cuenta de Dropbox esté vinculada) (мод2)
